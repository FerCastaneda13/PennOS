\hypertarget{user_8h}{}\doxysection{src/kernel/user.h File Reference}
\label{user_8h}\index{src/kernel/user.h@{src/kernel/user.h}}
...
\item 
bool \mbox{\hyperlink{user_8h_aba0bd39ac1403897db3bfb2b4aa6edc2}{W\+\_\+\+WIFEXITED}} (int $\ast$wstatus)
\begin{DoxyCompactList}\small\item\em Check if the child process has exited. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{user_8h_a398b4ebc66eeb1bfd57df6bc4d40f448}{W\+\_\+\+WIFSTOPPED}} (int $\ast$wstatus)
\begin{DoxyCompactList}\small\item\em Check if the child process has been stopped. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{user_8h_a9effa01864c0e66c69308bed3e18066c}{W\+\_\+\+WIFSIGNALED}} (int $\ast$wstatus)
\begin{DoxyCompactList}\small\item\em Check if the child process has been signaled. \end{DoxyCompactList}\item 
pid\+\_\+t \mbox{\hyperlink{user_8h_afdf2d5e232f639455ab3c39321fb93d1}{p\+\_\+spawn}} (void($\ast$func)(), char $\ast$argv\mbox{[}$\,$\mbox{]}, int fd0, int fd1)
...
pid\+\_\+t \mbox{\hyperlink{user_8h_aee844cf4d46e79b4d2bed4ac8fa87038}{p\+\_\+spawn\+\_\+shell}} (void($\ast$func)(), int fd0, int fd1)
...
pid\+\_\+t \mbox{\hyperlink{user_8h_a8ddf9a2934c3397ab06f48872bc24ce6}{p\+\_\+waitpid}} (pid\+\_\+t pid, int $\ast$wstatus, bool \mbox{\hyperlink{stress_8h_abaaeefe806d9f0dced0ea5a1f6f21fe5}{nohang}})
\begin{DoxyCompactList}\small\item\em Wait for a child process to change state. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{user_8h_a51b0c5be136911b0b56288a08fde4f4a}{p\+\_\+kill}} (pid\+\_\+t pid, int sig)
\begin{DoxyCompactList}\small\item\em Send a signal to a thread. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{user_8h_a9c62837d1387bfa1fe4df7297efd4343}{collect\+Child}} (\mbox{\hyperlink{structPCB}{PCB}} $\ast$child, int $\ast$wstatus)
\begin{DoxyCompactList}\small\item\em Collect information about a child process. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{user_8h_abab29a9906bac0b035d41a3c067d9c36}\label{user_8h_abab29a9906bac0b035d41a3c067d9c36}} 
void \mbox{\hyperlink{user_8h_abab29a9906bac0b035d41a3c067d9c36}{p\+\_\+exit}} (void)
\begin{DoxyCompactList}\small\item\em Exit the current thread unconditionally. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{user_8h_a04ac94d68aaa795abdeed08f2d9481a3}{p\+\_\+nice}} (pid\+\_\+t pid, int priority)
\begin{DoxyCompactList}\small\item\em Change the priority of a process. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{user_8h_a44e7020c166926f5ea422998ec262653}{p\+\_\+sleep}} (unsigned int ticks)
...
\mbox{\Hypertarget{user_8h_a9c62837d1387bfa1fe4df7297efd4343}\label{user_8h_a9c62837d1387bfa1fe4df7297efd4343}} 
\index{user.h@{user.h}!collectChild@{collectChild}}
\index{collectChild@{collectChild}!user.h@{user.h}}
\doxysubsubsection{\texorpdfstring{collectChild()}{collectChild()}}
{\footnotesize\ttfamily void collect\+Child (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structPCB}{PCB}} $\ast$}]{child,  }\item[{int $\ast$}]{wstatus }\end{DoxyParamCaption})}
...
{\em child} & Pointer to the \mbox{\hyperlink{structPCB}{PCB}} of the child process. \\
\hline
{\em wstatus} & Pointer to the status of the child process. \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{user_8h_a51b0c5be136911b0b56288a08fde4f4a}\label{user_8h_a51b0c5be136911b0b56288a08fde4f4a}} 
\index{user.h@{user.h}!p\_kill@{p\_kill}}
\index{p\_kill@{p\_kill}!user.h@{user.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_a04ac94d68aaa795abdeed08f2d9481a3}\label{user_8h_a04ac94d68aaa795abdeed08f2d9481a3}} 
\index{user.h@{user.h}!p\_nice@{p\_nice}}
\index{p\_nice@{p\_nice}!user.h@{user.h}}
...
0 on success, or -\/1 on error. 
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_a44e7020c166926f5ea422998ec262653}\label{user_8h_a44e7020c166926f5ea422998ec262653}} 
\index{user.h@{user.h}!p\_sleep@{p\_sleep}}
\index{p\_sleep@{p\_sleep}!user.h@{user.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{user_8h_afdf2d5e232f639455ab3c39321fb93d1}\label{user_8h_afdf2d5e232f639455ab3c39321fb93d1}} 
\index{user.h@{user.h}!p\_spawn@{p\_spawn}}
\index{p\_spawn@{p\_spawn}!user.h@{user.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_aee844cf4d46e79b4d2bed4ac8fa87038}\label{user_8h_aee844cf4d46e79b4d2bed4ac8fa87038}} 
\index{user.h@{user.h}!p\_spawn\_shell@{p\_spawn\_shell}}
\index{p\_spawn\_shell@{p\_spawn\_shell}!user.h@{user.h}}
...
The PID of the child thread on success, or -\/1 on error. 
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_a8ddf9a2934c3397ab06f48872bc24ce6}\label{user_8h_a8ddf9a2934c3397ab06f48872bc24ce6}} 
\index{user.h@{user.h}!p\_waitpid@{p\_waitpid}}
\index{p\_waitpid@{p\_waitpid}!user.h@{user.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_aba0bd39ac1403897db3bfb2b4aa6edc2}\label{user_8h_aba0bd39ac1403897db3bfb2b4aa6edc2}} 
\index{user.h@{user.h}!W\_WIFEXITED@{W\_WIFEXITED}}
\index{W\_WIFEXITED@{W\_WIFEXITED}!user.h@{user.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_a9effa01864c0e66c69308bed3e18066c}\label{user_8h_a9effa01864c0e66c69308bed3e18066c}} 
\index{user.h@{user.h}!W\_WIFSIGNALED@{W\_WIFSIGNALED}}
\index{W\_WIFSIGNALED@{W\_WIFSIGNALED}!user.h@{user.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{user_8h_a398b4ebc66eeb1bfd57df6bc4d40f448}\label{user_8h_a398b4ebc66eeb1bfd57df6bc4d40f448}} 
\index{user.h@{user.h}!W\_WIFSTOPPED@{W\_WIFSTOPPED}}
\index{W\_WIFSTOPPED@{W\_WIFSTOPPED}!user.h@{user.h}}
